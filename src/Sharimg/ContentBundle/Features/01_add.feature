...
Scenario: 2/ Add a content using url_content
    ...
    And I fill in "from" with "Google.fr (behat)"
    And I fill in "content_url" with "https://www.google.fr/images/srpr/logo11w.png"
...
Scenario: 2/ Add a content using url_content
    ...
    And I fill in "from" with "FileInput (behat)"
